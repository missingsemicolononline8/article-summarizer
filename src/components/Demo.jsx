        ...
        <section className="mt-16 w-full max-w-xl">
            ...
            <div className="flex flex-col w-full gap-2">
                <form action="" className='relative flex justify-center items-center' onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className='submit_btn peer-focus:border-gray-900 peer-focus:text-gray-700'>⏎</button>
                </form>

                {/* Browse URL History */}
                <div className="flex flex-col gap-1 max-h-60 overflow-y-auto">
                    {allArticles.map((item, index) => {
                        return <div key={`link-${index}`} onClick={() => setArticle(item)} className='link_card'>
